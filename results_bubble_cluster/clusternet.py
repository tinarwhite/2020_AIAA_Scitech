...
plotting = True
pflag = 'all_save'
learn_type = 'initialize' # 'sft', 'init_f', 'init_c', 'segment', 'initialize', 'context' or 'mlsp' or 'mlp' or 'mlpsc' or 'mlpec' or 'resnet'
learn_vars = 'Adam', 0.8, 0.8, 1.0*10**-12
...
#n_hidden = [[40,40,40],[]]
batch_ratio = 0.0005
n_clusters_network = 4
norm_type = 'L1'

n_hidden_runs = [[[15]*3,[15]*3]]
...
lr_vars_runs = [['exp', 0.0001, 1.0, num_epochs]] #[['exp', 0.1, 0.0002, num_epochs]] good one
